...
function AssistantDrawerInner() {
  ...
  async function permanentlyDeleteThread(item: AssistantThread) {
    ...
    if (!window.confirm(`Permanently delete “${item.title || "Archived conversation"}”? This cannot be undone.`)) return;
    setError(null);
    try {
