...
- [x] **Inspiration 1f** — Report schedule rehydration: persisted report templates now restore recurring schedules when the schedule library is available, so recurring exports survive restarts without adding a workflow engine.
