    ...
    def _render_systemd_unit(self, site_id: str) -> str:
        ...
        return "\n".join(
            [
                ...
                f"ExecStart={site_root}/runtime/.venv/bin/python -m services.cli.datastreamd up --site-profile {site_root}/site-profile.yaml",
                "",
                "[Install]",
    ...
    def _render_windows_install(self, site_id: str) -> str:
        ...
        return "\n".join(
            [
                ...
                "cd /d \"$runtimeTarget\"",
                "\"$pythonExe\" -m services.cli.datastreamd up --site-profile \"$(Join-Path $TargetDir 'site-profile.yaml')\"",
                "\"@",
